...
import co.edu.unipiloto.estdatos.tallergen.mundo.Computador.SistOperativo;
...
public class Main {
    ...
    public void agregarCamisa() throws Exception {
        ...
        Marca[] marc = Marca.values();
        
         for (int i = 0; i < marc.length; i++) {
            System.out.println("[" + (i + 1) + "] " + marc[i]);
        }
         
          int indice = Integer.parseInt(br.readLine());
        Marca marca = marc[indice - 1];
    ...
    public void agregarComputador() throws Exception {
        ...
        SistOperativo[] SisOp = SistOperativo.values();
        
         for (int i = 0; i < SisOp.length; i++) {
            System.out.println("[" + (i + 1) + "] " + SisOp[i]);
        }
         
          int indice = Integer.parseInt(br.readLine());
        SistOperativo sistOperativo = SisOp[indice - 1];
       ...
       Gama[] gamas = Gama.values();
        ...
        Producto computador = new Computador(sistOperativo, gama, precio);
